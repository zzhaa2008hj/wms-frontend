...
export class NewChargeInfo {
  ...
  async activate({id}) {
    this.chargeInfo = await this.chargeAuditListService.getChargeAudit(id);
    this.chargeInfo.chargeStartDate = new Date(this.chargeInfo.chargeStartDate);
    this.chargeInfo.chargeEndDate = new Date(this.chargeInfo.chargeEndDate);
  ...
  async update() {
    ...
    this.disabled = true;
    try {
      await this.chargeAuditListService.updateChargeInfoAndAuditList(this.chargeInfo.id, this.chargeInfo);
